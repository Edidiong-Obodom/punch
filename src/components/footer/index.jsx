...
const Footer = () => {
  return (
    <section className="half-background mt-20 text-white">
      <div className="bg-[#0C0C0C] slanted-border h-[480px] w-full mt-5 py-[3rem]">
      ...
      <div className="flex flex-col md:flex-row eddyContainerFull">
        <LinksAndRedirects />
      </div>
